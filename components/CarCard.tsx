        ...
        <div className='relative w-full h-40 my-3 object-contain'>
            ...
            <div className='relative flex w-full mt-2'>
                ...
                <div className='car-card__btn-container'>
                    <CustomButton title='view More' containerStyles='w-full py-[16px] rounded-full bg-primary-blue' textStyles='text-white text-[14px] leading-[17px] font-bold' rightIcon="/right-arrow.svg" handleClick={()=>setIsOpen(true)}></CustomButton>
                </div>
            </div>
